...
export default function HomePage() {
      ...
      <section id="home" className="section !pb-8 md:!pb-10">
        <div className="container text-center">
          ...
          <p id="hero-tagline" className="mt-6 text-lg opacity-80 max-w-2xl mx-auto">
            Software Engineering student — passionate about building apps and learning by doing.
          </p>
          <div id="hero-buttons" className="mt-8 flex items-center justify-center gap-3">
            ...
            <a className="btn-secondary rounded-xl border px-5 py-3 no-underline" href="#contact" data-btn>Contact</a>
          </div>
        </div>
      </section>
  ...
  <div className="mt-6 gsap-fade-up flex flex-wrap gap-3">
    <a
      href="/resume"
      className="btn-primary inline-flex items-center gap-2 rounded-xl bg-black text-white dark:bg-white dark:text-black px-5 py-3 font-medium no-underline"
      data-btn
    >
    ...
    <a
      ...
      target="_blank"
      className="btn-secondary inline-flex items-center gap-2 rounded-xl border px-5 py-3 no-underline"
      data-btn
    >
